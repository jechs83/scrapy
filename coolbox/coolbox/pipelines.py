...
import logging
import pymongo
from coolbox.settings import COLLECTION_NAME
...
class MongoPipeline(object):
    ...
    #     filter = { "_id":item["_id"],"sku": item["sku"],"date":item["date"],"list_price":item["list_price"], "best_price": item["best_price"],"card_price": item["card_price"] }
    #     update = {'$set': {
    #                     'best_price': 1689.0,
    #                     'brand': item["brand"],
