        ...
        if response.status_code == 200:
            ...
            if preloaded_state_content:
                ...
                if productos:
                 ...
                 # Verificar si el documento ya existe y si necesita ser actualizado
                        existing_doc = collection.find_one({"sku": part_number})
                        if existing_doc:
                            if (existing_doc['list_price'] != product_doc['list_price'] or
                                existing_doc['best_price'] != product_doc['best_price'] or
                                existing_doc['card_price'] != product_doc['card_price'] or
                                existing_doc['web_dsct'] != product_doc['web_dsct']):
